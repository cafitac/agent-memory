...
- Local verification on 2026-05-07: `uv run pytest tests/ -q` passed after the v0.1.90 same-scope episode drift fixture; checked-in retrieval-eval coverage is now 18 tasks.
