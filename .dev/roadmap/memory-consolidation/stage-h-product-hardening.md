...
Status: complete for the first retrieval-eval hardening slice before `v0.1.83`, with follow-up cross-scope procedure coverage released in `v0.1.85`.
...
- Local verification on 2026-05-06: `.venv/bin/python -m pytest tests/ -q` -> `257 passed` after the v0.1.85 cross-scope procedure fixture.
...
Status: complete in PR #161; live runtime follow-up verified in v0.1.85.
...
- `docs/install-smoke.md` reflects the v0.1.84 validated release, current npm/uvx command shapes, and backup/restore smoke coverage; v0.1.85 runtime QA was recorded in the handoff after PR #162/#163.
