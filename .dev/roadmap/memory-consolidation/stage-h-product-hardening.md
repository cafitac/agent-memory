...
- Local verification on 2026-05-07: `uv run pytest tests/ -q` passed after the v0.1.90 same-scope episode drift fixture; checked-in retrieval-eval coverage is now 17 tasks.
...
- `docs/install-smoke.md` reflects the v0.1.84 validated release, current npm/uvx command shapes, and backup/restore smoke coverage; v0.1.85, v0.1.86, v0.1.87, v0.1.88, v0.1.89, and v0.1.90 runtime QA were recorded in the handoff after PR #162/#163, PR #165/#166, PR #168/#169, PR #171/#173, PR #175/#176, and PR #178/#179.
