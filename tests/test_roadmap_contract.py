...
def test_v0151_status_docs_record_current_brainlike_runway_and_blocked_broad_apply() -> None:
    ...
    for doc in (next_action, handoff, current_progress):
        assert "v0.1.151" in doc
        assert "/Users/reddit/.agent-memory/runtime/v0.1.151/.venv/bin/agent-memory" in doc
