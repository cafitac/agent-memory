...
def test_python_module_cli_dogfood_query_preview_cleanup_restore_apply_is_contract_blocked_without_mutation_or_leaks(
    ...
    approval_token_expected_sha256 = hashlib.sha256(b"different-approval-token").hexdigest()
    ...
    assert audit_write_apply["blocked_reasons"] == [
        ...
        "restore_audit_write_approval_token_hash_mismatch",
    ]
    ...
    assert approval_packet["approval_token_hash_matches_expected"] is False
    assert approval_packet["approval_token_validation_status"] == "hash_mismatch"
    ...
    assert approval_packet["write_blocked_by_approval_hash_mismatch"] is True
    ...
    assert "restore_audit_write_approval_token_hash_mismatch" in audit_write_apply["blocked_reasons"]
    assert "restore_audit_write_approval_token_hash_mismatch" in approval_packet["blocked_reasons"]
